            ...
            <section className="service-two">
                ...
                <div className="container">
                    <div className="sec-title-two text-center sec-title-animation animation-style1">
                        ...
                        <p>We deliver scalable and affordable digital solutions to bring your ideas to life.</p>
                    </div>
                    <div className="row">
                        {/* Services Cards */}
                        {[
                            ...
                            <div key={index} className="col-xl-3 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay={service.delay}>
                                <div className="service-two__single">
                                <div className={`service-two__single-icon-box color${(index % 8) + 1}`}>
                                <span className={service.iconClass}>
                                    ...
                                    <div className="overlay-btn">
                                        <Link href={service.href}>Learn More <span className="icon-next"></span></Link>
                                    </div>
                                </div>
                            </div>
                        ))}
